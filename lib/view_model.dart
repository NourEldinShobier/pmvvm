...
class ViewModel extends ChangeNotifier {
  ...
  /// Event callback when the application is visible and responding
  /// to user input.
  void onResume() {}

  /// Event callback when the application is not currently visible to
  /// the user, not responding to user input, and running in the background.
  void onPause() {}

  /// - Event callback when the application is in an
  ///   inactive state and is not receiving user input.
  /// - For [IOS] only.
  void onInactive() {}

  /// - Event callback when the application is still hosted
